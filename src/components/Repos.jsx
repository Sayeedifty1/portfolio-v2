    ...
    >
      <div className="cursor-pointer group relative bg-gray-500/5 shadow-lg border border-gray-500/25 hover:border-primary hover:shadow-xl rounded-lg overflow-hidden p-4 transition-all duration-200 mx-4 lg:mx-0">
        <div className="absolute w-full h-full top-0 right-0 transition-all duration-200">
          <img
            src={`https://opengraph.githubassets.com/15ced7abddd056302fa4e531c75f0c1e3510242eca654c93dd8a8f2b5cc92d44/${full_name}`}
            alt="repo's image"
            className="opacity-50 group-hover:opacity-100 transition-all duration-200 w-full h-full rounded-lg"
          />
          <div
            className={`absolute w-full h-full top-0 right-0 bg-gradient-to-t  dark:text-white  dark:hover:text-gray-200 dark:from-black/90 dark:to-black/60 text-black hover:text-gray-800 from-white/80  to-white/40`}
          />
        </div>
        <div className="relative">
          <h2
            className={`font-display text-lg font-medium dark:text-white  dark:hover:text-gray-200 text-black hover:text-gray-800`}
          >
            {name}
          </h2>
